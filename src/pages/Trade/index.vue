<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(goods,index) in detailArrayList" :key="goods.tradeNo">
          <li>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{deaultuser.userAddress}}</span>
        收货人：
        <span>{{deaultuser.consignee}}</span>
        <span>{{deaultuser.phoneNum}}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder(){
      ...
      // params参数
      let tradeInfo = {
        consignee: this.deaultuser.consignee,
        consigneeTel: this.deaultuser.phoneNum,
        deliveryAddress: this.deaultuser.userAddress,
        paymentWay: "ONLINE",
